...
public class GUIQLPhong extends JPanel implements MouseListener, ActionListener {
	...
	public GUIQLPhong(Frame parent) {
		...
		b2.add(Box.createHorizontalStrut(20));
		b2.add(textfieldMaPhong = new JTextField(10));
		textfieldMaPhong.setPreferredSize(new Dimension(80, 30));
		b2.add(Box.createHorizontalStrut(20));
		...
		textfieldGiaPhong.setPreferredSize(new Dimension(80, 30));
		b2.add(Box.createHorizontalStrut(20));
		b1.add(Box.createVerticalStrut(20));
		b1.add(b2 = Box.createHorizontalBox());
		b2.add(Box.createHorizontalStrut(20));
		...
		textfieldGhiChu.setPreferredSize(new Dimension(80, 30));
		b2.add(Box.createHorizontalStrut(20));
		b1.add(Box.createVerticalStrut(20));
		b1.add(b2 = Box.createHorizontalBox());
		b2.add(Box.createHorizontalStrut(20));
...
//		b2.add(btnLuu = new JButton("Lưu", new ImageIcon(".\\image\\save.png")));
		...
		b1.add(b2 = Box.createHorizontalBox());
		b2.add(btnBack = new JButton("Lùi Về Trang Trước", new ImageIcon(".\\image\\btn-back.png")));
...
//		btnLuu.addActionListener(new luu());
	...
	public void them2() {
		try {
			...
			if (Pattern.matches("[0-9]+", textfieldGiaPhong.getText().trim())==false) {
				JOptionPane.showMessageDialog(null, "Không nhập chữ", "Thông báo", 0,
	...
	private void updateTableData1(ArrayList<Phong> list) {
		...
		for (Phong p : list) {
			// Mã Phòng;Loại Phòng;Giá Phòng;Ghi Chú;Tình Trạng Phòng;Tên Khách
			// Hàng;CMND;Ngày Sinh;Giới Tính
